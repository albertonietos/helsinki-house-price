...
class DataCleaner:
    ...
    def add_house_type_and_description(self):
        ...
        """
        self.data["House_type", "Description"] = self.data.Title.str.spilt(
            "|", expand=True
        )
    ...
    def add_rooms_from_description(self):
        ...
        self.data["Total_rooms"] = self.data.Description.str.split(
            "h|H|-|k|mh|\(|,|x|\+", expand=True
        )[0]
    ...
    def add_location_from_address(self):
        ...
        self.data["point"] = self.data["location"].apply(
